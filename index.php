...
<section class="hero">
	<div class="hero-copy">
		...
		<p class="lede">Enterprise-grade architecture, integration experience, and operational discipline delivered for small and medium local businesses that need smarter systems without unnecessary complexity.</p>
...
<section class="section">
	...
	<div class="card-grid">
		...
		<article class="card">
			...
			<p>12+ years across SaaS engineering, integrations, and technical consulting with experience supporting organizations such as Hilton, SAP, Formula 1, BBC, KLM, Turner, and Scripps.</p>
		</article>
		<article class="card">
			<h3>How Work Gets Done</h3>
			<p>Solo-led, hands-on delivery with strong attention to detail, direct communication, and a bias toward scalable decisions that stay practical for real-world budgets.</p>
		</article>
	</div>
